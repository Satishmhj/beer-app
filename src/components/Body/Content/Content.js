      ...
      <div className="container">
        ...
        <div className="row">
          {beers
            ...
            .filter((items) => {
              if (filterBeer?.abvMin && filterBeer?.abvMax) {
                if (
                  items.abv > filterBeer.abvMin &&
                  items.abv < filterBeer.abvMax
                ) {
                  return true;
                }
                return false;
            ...
            .map((items) => {
              ...
              return (
                <div key={id} className="col-lg-4 col-md-6 col-sm-12 mt-3">
                  <div className="card w-100">
                    ...
                    <ImageCard image={image} altText={name} />
